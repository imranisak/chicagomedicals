...
(39, 'DS9', 'Tehana Kuprešak', 42, 'info@ds9.com', 'Far away', 0, 'anesthesiologist', 'https://ds9.com', 'a:1:{i:0;s:44:\"/media/pictures/2021-07-02-09-22-19_ds9.jfif\";}', '', '', '', 1, 0, 0, 0, '2021-07-02 09:22:19');
...
CREATE TABLE IF NOT EXISTS `subscriptions` (
  ...
  `dateCreted` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `dateRenewed` varchar(250) DEFAULT NULL,
  `dateOfExpiry` varchar(250) NOT NULL,
  `failedCount` int NOT NULL DEFAULT '0',
  `lastFailedDate` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  PRIMARY KEY (`ID`)
...
INSERT INTO `subscriptions` (`ID`, `subscriptionID`, `userID`, `dateCreted`, `dateRenewed`, `dateOfExpiry`, `failedCount`, `lastFailedDate`) VALUES
(7, 'I-9V1YV6TKT2GM', 37, '2021-06-30T13:00:06Z', NULL, '', 0, NULL),
(6, 'I-5M7X1TWYSB55', NULL, '2021-06-30T12:59:52Z', NULL, '', 0, NULL),
(5, 'I-CDR4AGAH3RG0', 41, '2021-06-30T12:50:20Z', NULL, '', 0, NULL),
(8, 'I-5D38502DDBH1', NULL, '2021-06-30T13:12:30Z', NULL, '', 0, NULL),
(9, 'I-W58KECV4UDE7', 37, '2021-06-30T13:13:57Z', NULL, '', 0, NULL),
(10, 'I-9KS5W6TM3SF8', 37, '2021-06-30T13:19:28Z', NULL, '', 0, NULL),
(11, 'I-ASB67NCUH41D', 37, '2021-06-30T13:23:25Z', NULL, '', 0, NULL);
...
(37, 'Jean-Luc', 'Picard', 'picard@starfleet.com', '/media/pictures/2021-02-17-15-56-36_picard2.jpg', '$2y$10$rhyrz96BqyYEYtdGYKNRPOJf0ADKc28c32uDWZxDcbWuL8fvaAS8.', 1, 0, 'user', 1, '2020-12-28'),
(38, 'Tom', 'Paris', 'tomparis@starfleet.com', '/media/pictures/2021-07-02-09-46-33_paris.jpg', '$2y$10$lz7V2EliL7oNm0YuZR9g/urlQxwcMDSgEhXREmc37OW2oAV11wsgi', 1, 0, 'user', 0, '2020-12-28'),
(39, 'Benjamin', 'Sisko', 'badass@starfleet.com', '/media/pictures/2021-07-01-10-53-01_sisko.jpg', '$2y$10$XIdRCbtb5NJlWIEw766KZOfjUBaMtLmJG.bMYUnXP1RgMliyu6Pra', 1, 0, 'user', 0, '2020-12-28'),
...
(41, 'Edward', 'Harmon', 'EdwardSHarmon@jourrapide.com', '/media/pictures/2021-06-30-09-24-56_person.jfif', '$2y$10$WRMhfkk/rXqQvD9qtuBbSuK3H6QdqaSR82iuUUxwcFQh.GN6.QbuW', 1, 0, 'user', 1, '2021-01-28'),
(42, 'Tehana', 'Kuprešak', 'tehanakupresak@jourrapide.com', '/media/pictures/2021-01-28-21-31-50_sarah-parmenter.jpeg', '$2y$10$IqAa2cl2gyeAgYk/M5.3uOQyB1549kvLBBCHA.MsjoIX0gUK6jvnW', 1, 1, 'user', 1, '2021-01-28'),
...
(45, 'Hrle', 'The Second The Glorious', 'hrle@thesecond.com', '/media/pictures/profilepicture.jpg', '$2y$10$u.JRkGQQQT0msGutBL1yT.NKCRvEdIS7iJd9nLKzXWJfQPy6cuQTG', 1, 0, 'user', 0, '2021-01-28'),
